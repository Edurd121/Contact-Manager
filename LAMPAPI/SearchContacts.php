<?php
	...
	else
	{
		...
		$stmt->bind_param("sssss", $searchVal, $searchVal, $searchVal, $searchVal, $inData["userId"]);
		$stmt->execute();
		...
		while($row = $result->fetch_assoc())
		{
			...
			$searchCount++;
			$searchResults .= '"Name: ' . $row["FirstName"] . ' ' . $row["LastName"] . ', Phone: ' . $row["Phone"] . ', Email: ' . $row["Email"] . '"';
		}
